...
func printHelp() {
	...
	fmt.Println("")
	fmt.Println("\033[1mask login\033[0m\x1b[3m connect your account\x1b[0m")
	fmt.Println("\033[1mask logout\033[0m\x1b[3m remove your account\x1b[0m")
	fmt.Println("")
